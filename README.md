...
- 6 npm packages with comprehensive documentation
...
- Code Quality: oxlint, ESLint, Prettier, osv-scanner
...
Published maintainer of [lti-tool](https://github.com/lti-tool/lti-tool) - for serverless LTI 1.3 integration.
...
---
*Open to discussing serverless architecture, EdTech infrastructure, modern framework 
adoption (Astro, Hono), or collaborating on open source projects.*
